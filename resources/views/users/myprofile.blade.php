...
<div class="row justify-content-between align-items-center">
    <div class="col-sm-12 col-md-3">
          <img src="{{asset('storage/'.$user->profile_pic)}}"  width="100%" style="border-radius:20px" alt="">
...
<div class="col-sm-12 col-md-8">
        <p class="fs-3 mb-5">Role: <span class="px-2 py-1 rounded border border-1 border-primary">{{$user->role}}</span></p>
